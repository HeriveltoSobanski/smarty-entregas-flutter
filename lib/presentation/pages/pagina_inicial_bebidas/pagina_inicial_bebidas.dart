      ...
      child: Stack(
        ...
        children: [
          PageView(
            ...
            children: const [
              _BannerItem('Bebidas', 'Geladas e refrescantes!'),
              _BannerItem('Bebidas', 'Entrega rápida em Mallet'),
            ],
          ),
          Positioned(
            bottom: 10,
        ...
        children: [
          ClipRRect(
            ...
            child: Container(
              ...
              child: const Icon(Icons.local_drink, color: AppColors.primary, size: 36),
            ),
          ),
          Padding(
