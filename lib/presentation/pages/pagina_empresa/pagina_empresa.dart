...
class _PaginaEmpresaState extends State<PaginaEmpresa> {
      ...
      builder: (ctx) => PopScope(
        ...
        child: AlertDialog(
          ...
          title: Row(children: [
            ...
            const Expanded(child: Text('EndereÃ§o obrigatÃ³rio', style: TextStyle(fontSize: 17))),
          ]),
          content: const Text(
            'Para que os motoboys consigam encontrar sua empresa, '
            'vocÃª precisa cadastrar o endereÃ§o antes de continuar.',
  ...
  Future<void> _salvarEndereco(EnderecoSelecionado res) async {
    ...
    if (erro != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('EndereÃ§o salvo com sucesso!'), backgroundColor: Colors.green),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: IndexedStack(
        index: _aba,
        children: const [_TabProdutos(), _TabPedidos(), _TabConta()],
      ),
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        // â”€â”€ Lista â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        Expanded(
          child: _carregando
                  ...
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Nenhum produto no cardÃ¡pio',
                              style: GoogleFonts.poppins(
                                  fontSize: 15, fontWeight: FontWeight.w600, color: _darkText)),
                          const SizedBox(height: 4),
                          Text('Adicione seu primeiro item para comeÃ§ar.',
...
// â”€â”€ Card de produto â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // â”€â”€ Imagem â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
          ClipRRect(
          ...
          // â”€â”€ Corpo â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
          Padding(
          ...
          // â”€â”€ Barra de aÃ§Ãµes â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
          Padding(
...
// â”€â”€ FormulÃ¡rio de adiÃ§Ã£o / ediÃ§Ã£o de produto â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class _FormProdutoState extends State<_FormProduto> {
  ...
  Future<void> _salvar() async {
    ...
    if (nome.isEmpty || preco <= 0 || _catSel == null) {
      setState(() => _erro = 'Preencha nome, preÃ§o e categoria.');
      return;
    }
    ...
    if (_editando) {
      ...
      if (idEmpresa == null) { setState(() { _salvando = false; _erro = 'SessÃ£o expirada.'; }); return; }
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 4),
            Text(
              _editando ? 'Altere os dados do produto' : 'Preencha os dados do item do cardÃ¡pio',
            ...
            TextField(
              ...
              decoration: _deco('PreÃ§o (R\$) *'),
            ),
            const SizedBox(height: 12),
            TextField(
              controller: _descricaoCtrl,
              maxLines: 3,
              decoration: _deco('Ingredientes / DescriÃ§Ã£o'),
            ),
            const SizedBox(height: 12),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: _salvando
                    ...
                    : Text(
                        _editando ? 'Salvar alteraÃ§Ãµes' : 'Adicionar ao cardÃ¡pio',
                        style: GoogleFonts.poppins(
...
class _AdicionaisSheetState extends State<_AdicionaisSheet> {
  ...
  Future<void> _salvar() async {
    ...
    if (nome.isEmpty || grupo.isEmpty) {
      setState(() => _erro = 'Nome e grupo sÃ£o obrigatÃ³rios.');
      return;
    }
      ...
      builder: (_, scrollCtrl) => Padding(
        ...
        child: ListView(
          ...
          children: [
            ...
            Text('OpÃ§Ãµes extras que o cliente pode escolher',
                style: GoogleFonts.poppins(fontSize: 12, color: _muted)),
            const SizedBox(height: 16),
                      ...
                      child: Row(children: [
                        ...
                        if (obrig)
                          Container(
                            ...
                            child: Text('OBRIGATÃ“RIO',
                                style: GoogleFonts.poppins(color: Colors.white, fontSize: 9, fontWeight: FontWeight.bold)),
                          ),
                        const SizedBox(width: 6),
                        Text('mÃ¡x $max', style: GoogleFonts.poppins(fontSize: 11, color: _muted)),
                      ]),
                    ),
                    ...itens.map((item) {
                      ...
                      return ListTile(
                        ...
                        trailing: Row(mainAxisSize: MainAxisSize.min, children: [
                          Text(
                            precoVal == 0 ? 'GrÃ¡tis' : '+ R\$ ${precoVal.toStringAsFixed(2)}',
                            style: GoogleFonts.poppins(
                              fontWeight: FontWeight.bold,
            ...
            Row(children: [
              ...
              const SizedBox(width: 8),
              Expanded(child: TextField(controller: _maxCtrl, keyboardType: TextInputType.number, decoration: _deco('MÃ¡x'))),
            ]),
            const SizedBox(height: 8),
            Row(children: [
              Checkbox(value: _obrigatorio, onChanged: (v) => setState(() => _obrigatorio = v ?? false), activeColor: _cor),
              Text('ObrigatÃ³rio', style: GoogleFonts.poppins(fontSize: 13)),
            ]),
            const SizedBox(height: 4),
            TextField(controller: _nomeCtrl, decoration: _deco('Nome do item *')),
            const SizedBox(height: 8),
            TextField(controller: _descCtrl, decoration: _deco('DescriÃ§Ã£o (opcional)')),
            const SizedBox(height: 8),
            TextField(
              controller: _precoCtrl,
              keyboardType: const TextInputType.numberWithOptions(decimal: true),
              decoration: _deco('PreÃ§o extra (0 = grÃ¡tis)'),
            ),
            const SizedBox(height: 8),
            if (_erro != null)
              Padding(
...
class _TabPedidosState extends State<_TabPedidos> {
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        title: Row(children: [
          ...
          Text('RelatÃ³rio', style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 17)),
        ]),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('${_fmtBR(_dataInicio)} â€“ ${_fmtBR(_dataFim)}',
            ...
            _linhaRelatorio('Valor lÃ­quido', 'R\$ ${(total - taxa).toStringAsFixed(2)}',
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        // â”€â”€ Header de mÃ©tricas â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        Container(
          color: _card,
          ...
          child: Column(
            ...
            children: [
              ...
              Row(children: [
                ...
                const SizedBox(width: 8),
                Expanded(child: _ChipData('AtÃ©: ${_fmtBR(_dataFim)}', () => _selecionarData(false))),
              ]),
        ...
        // â”€â”€ Lista de pedidos â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        Expanded(
          child: _carregando
              ? const Center(child: CircularProgressIndicator(color: _cor))
              : _pedidos.isEmpty
        ...
        // â”€â”€ BotÃ£o relatÃ³rio â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        Container(
          color: _card,
          ...
          child: OutlinedButton.icon(
            ...
            label: Text('Gerar relatÃ³rio do perÃ­odo',
...
// â”€â”€ Card de pedido â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// =============================================================
// PEDIDO â€” detalhe sheet (empresa)
// =============================================================
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text('${qtd}Ã—  R\$ ${preco.toStringAsFixed(2)}',
                    ...
                    if (quasePronto)
                      Padding(
                        ...
                        child: Row(children: [
                          ...
                          const SizedBox(width: 6),
                          Text('Cliente avisado que estÃ¡ quase pronto',
                    ...
                    if (tipoEntrega.isNotEmpty)
                      Padding(
                        ...
                        child: Row(children: [
                          ...
                          const SizedBox(width: 6),
                          Text(
                            tipoEntrega == 'propria' ? 'Entrega prÃ³pria em andamento' : 'Aguardando motoboy',
                        ...
                        if (idStatus < 4 && idStatus != 6)
                          Expanded(
                            child: ElevatedButton.icon(
                              ...
                              label: Text(_statusNomes[idStatus + 1] ?? 'AvanÃ§ar',
                                  style: GoogleFonts.poppins(fontWeight: FontWeight.bold)),
                            ),
                          ),
...
class _TabContaState extends State<_TabConta> {
  ...
  Future<void> _carregar() async {
    ...
    if (id != null) {
      ...
      final fotos   = results[2] as Map<String, String?>;
  ...
  Future<void> _editarEndereco() async {
    ...
    if (erro != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('EndereÃ§o atualizado!'), backgroundColor: Colors.green),
      );
    }
  }
  ...
  Future<void> _editarConfiguracoes() async {
    ...
    final salvo = await showDialog<bool>(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setS) => AlertDialog(
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
          title: Text('ConfiguraÃ§Ãµes de entrega',
            ...
            children: [
              TextField(
                ...
                decoration: InputDecoration(
                  labelText: 'Taxa mÃ­nima (R\$)',
                  prefixText: 'R\$ ',
                  helperText: 'MÃ­nimo cobrado por entrega. Ex: 7.00',
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixText: 'min',
                  helperText: 'Tempo mÃ©dio atÃ© ficar pronto. Ex: 30',
                  border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)),
                  filled: true, fillColor: _bgPage,
                ),
              ),
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                if (taxa == null || taxa < 0) { setS(() => erro = 'Taxa invÃ¡lida.'); return; }
                if (tempo == null || tempo < 1) { setS(() => erro = 'Tempo invÃ¡lido.'); return; }
                final id = SessionStore.idEmpresa;
                if (id == null) return;
    ...
    if (salvo == true && mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('ConfiguraÃ§Ãµes salvas!'), backgroundColor: Colors.green),
      );
    }
  }
  ...
  double get _totalGeral =>
      _totalStatus('Entregue') + _totalStatus('Em Preparo') + _totalStatus('A Caminho');
  ...
  double get _totalSemana {
    ...
    return _pedidos.where((p) {
      ...
      try {
        final d = DateTime.parse(p['criado_em']?.toString() ?? '');
        return d.isAfter(DateTime(inicioSemana.year, inicioSemana.month, inicioSemana.day)
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // â”€â”€ SEÃ‡ÃƒO: PERFIL â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            _SecaoLabel('Perfil'),
            const SizedBox(height: 10),
            ...
            // â”€â”€ SEÃ‡ÃƒO: OPERAÃ‡ÃƒO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            _SecaoLabel('OperaÃ§Ã£o'),
            const SizedBox(height: 10),

            // Grupo de configuraÃ§Ãµes (iOS-style)
            Container(
              decoration: BoxDecoration(
                color: _card,
                borderRadius: BorderRadius.circular(16),
              ...
              child: Column(
                children: [
                  ...
                  _SettingsRow(
                    ...
                    subtitle: temEndereco ? _endereco! : 'NÃ£o cadastrado â€” obrigatÃ³rio',
                    subtitleColor: temEndereco ? null : Colors.red,
                    trailing: temEndereco ? null : Container(
                      padding: const EdgeInsets.symmetric(horizontal: 7, vertical: 3),
                      decoration: BoxDecoration(color: Colors.red, borderRadius: BorderRadius.circular(6)),
                      child: Text('ObrigatÃ³rio', style: GoogleFonts.poppins(color: Colors.white, fontSize: 10, fontWeight: FontWeight.bold)),
                    ),
                  ...
                  _SettingsRow(
                    ...
                    subtitle: 'Taxa mÃ­nima: R\$ ${_taxaMinima.toStringAsFixed(2)}  Â·  Preparo: $_tempoPreparo min',
            ...
            // â”€â”€ SEÃ‡ÃƒO: FINANCEIRO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            _SecaoLabel('Financeiro'),
            const SizedBox(height: 10),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: _cor.withValues(alpha: 0.35),
                    blurRadius: 16,
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  Text('Todos os pedidos nÃ£o cancelados',
            ...
            Container(
              ...
              child: Column(children: [
                _LinhaDetalhe('Receita bruta', 'R\$ ${_totalMes.toStringAsFixed(2)}', Colors.green),
                Divider(height: 16, color: Colors.grey.shade100),
                _LinhaDetalhe('Taxa Smarty (15%)', '- R\$ ${taxa.toStringAsFixed(2)}', Colors.red),
                Divider(height: 16, color: Colors.grey.shade100),
                _LinhaDetalhe('Valor lÃ­quido', 'R\$ ${liquido.toStringAsFixed(2)}',
                    const Color(0xFF1565C0), bold: true),
              ]),
            ),
            const SizedBox(height: 20),
            ...
            Row(children: [
              Text('Ãšltimas transaÃ§Ãµes',
                  style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.bold, color: _darkText)),
              const Spacer(),
              Text('${_pedidos.where((p) => p['status'] != 'Cancelado').length} pedidos',
                  style: GoogleFonts.poppins(fontSize: 12, color: _muted)),
            ]),
            const SizedBox(height: 8),
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        Text(valor, style: GoogleFonts.poppins(
          color: cor, fontWeight: FontWeight.bold, fontSize: bold ? 15 : 13,
        )),
      ],
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(children: [
        Container(
          width: 36, height: 36,
          decoration: BoxDecoration(color: Colors.green.withValues(alpha: 0.10), borderRadius: BorderRadius.circular(10)),
        ...
        Text('+ R\$ ${valor.toStringAsFixed(2)}',
            style: GoogleFonts.poppins(color: Colors.green, fontWeight: FontWeight.bold, fontSize: 13)),
      ]),
    );
  }
}
...
// =============================================================
// MODAL â€” Selecionar motoboy da empresa para entrega prÃ³pria
// =============================================================
