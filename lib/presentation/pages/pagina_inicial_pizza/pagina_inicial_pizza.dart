...
class _PaginaInicialPizzaState extends State<PaginaInicialPizza> {
  ...
  Future<void> _carregarProdutos() async {
    ...
    final lista = await ApiService.getProdutosPublico(categoria: 'Pizzas');
    if (!mounted) return;
    if (lista == null) {
      ...
      child: Stack(
        ...
        children: [
          PageView(
            ...
            children: const [
              _BannerItem('Pizzas', 'As melhores pizzas de Mallet!'),
              _BannerItem('Pizzas', 'Promoções imperdíveis!'),
            ],
          ),
          Positioned(
            bottom: 10,
        ...
        children: [
          ClipRRect(
            ...
            child: Container(
              ...
              child: const Icon(Icons.local_pizza, color: AppColors.primary, size: 36),
            ),
          ),
          Padding(
