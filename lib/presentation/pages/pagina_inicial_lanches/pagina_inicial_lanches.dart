                  ...
                  ? SizedBox(
                      ...
                      : SizedBox(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (_, i) => _CardProduto(produto: _produtos[i], icone: Icons.fastfood),
                          ),
                        ),
      ...
      child: Stack(
        ...
        children: [
          PageView(
            ...
            children: const [
              _BannerItem('Lanches', 'Promoções de Lanches'),
              _BannerItem('Lanches', 'Os melhores lanches de Mallet!'),
            ],
          ),
          Positioned(
            bottom: 10,
...
class _CardProduto extends StatelessWidget {
  ...
  const _CardProduto({required this.produto, required this.icone});
        ...
        children: [
          ClipRRect(
            ...
            child: Container(
              ...
              child: Icon(icone, color: AppColors.primary, size: 36),
            ),
          ),
          Padding(
